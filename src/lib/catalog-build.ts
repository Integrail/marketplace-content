...
export async function buildCatalogItem(
    ...
    const heroMedia: IEverMarketplaceMedia = {
        kind: "image",
        url: ((heroUrlRaw ?? heroFileRaw) ?? "ew-marketplace://defaults/default-item-hero.png") as IEverMarketplaceUrl,
    };
    ...
    const dependencies = [
        ...
        parseDependencyGroup("worker", dep("ITEM_DEP_WORKERS_SUMMARY"), dep("ITEM_DEP_WORKERS")),
    ];
